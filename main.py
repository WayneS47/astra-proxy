# main.py — Rollback Stable Version + Static Moon Phase Table
# Version: ROLLBACK_2025_02_STABLE
...
async def weather_astro(lat: float = Query(...), lon: float = Query(...)):
    ...
    ipgeo_url = (
        f"https://api.ipgeolocation.io/astronomy?apiKey={os.getenv('IPGEO_API_KEY')}&lat={lat}&long={lon}"
    )
